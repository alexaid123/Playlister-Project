...
export const createPlaylist = (newListName, pID, newSongs, userName, userEmail, pb, cmt) => {
...
export const createPublishedPlaylist = (newListName, unpID, newSongs, userName, userEmail, pb, cmt) => {
